...
static void	children(int pipes[][2], t_command *command, t_gen_list *envioroment, int actua_pipe);
static void	partent(int pipes[][2], t_command *command, t_gen_list *envioroment, int actua_pipe);
