...
/**
 * @brief Iterator for a generic linked list.
 *
 ...
 * @param element_destroyer Function to free the value of each removed node, can be NULL.
 * @see t_predicate
 * @see t_element_destroyer
 */
void gen_list_remove_if(t_gen_list *list, t_predicate predicate, t_element_destroyer element_destroyer);
 ...
 * @see t_element_destroyer
 */
void gen_list_remove_if_ctx(t_gen_list *list, t_predicate_ctx predicate, void *context, t_element_destroyer element_destroyer);
 ...
 *
 * @param list List to traverse.
 * @param func Function to apply to each value, with signature (element, context).
 ...
 * @see t_predicate_ctx
 */
bool gen_list_has_ctx(t_gen_list *list, t_predicate_ctx predicate, void *context);
...
/**
 * @brief Convert a null-terminated array of strings into a generic linked list.
 *
