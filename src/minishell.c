...
/*   Updated: 2025/11/12 12:51:06 by lgrigore         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	handle_system_status_codes(int status_code,
...
static void	handle_command_status_codes(int status_code,
		t_mini_state *mini_state)
{
		...
		char *input)
{
	...
	else if (status_code >= SYSTEM_STATUS_BEGIN
		&& status_code <= SYSTEM_STATUS_END)
